...
init_strees([_12|_13],_4,_5) :-
   _12=stree(_14,(_X15:-_16),_X17,_18,_X19),
   bottom_call(_14,_20),
...
traverse_conj(_3,_4,_5,_6,_7,_8) :-
   ...
   traverse_conj(_4,_25,_6,_7,_8,_27,_X28,_26,_X29,_24,_X30),
   true.
...
update_goal(_3,_X4,_5,_5,_7,_7,_9,_10,_11,_12,_13,_13) :-
...
update_table(_15/_16,_4,_5,_6,_7,_8) :-
   ...
   _8 is _7+1,
   true.
update_table(_X15/_X16,_X4,_5,_5,_7,_7).
...
lattice_modes_arg(_Other, _X, Link, Link).
...
intersectv_3(<, _A, S1, B, S2,     S) :- intersectv_2(S1, B, S2, S).
intersectv_3(=, A, S1, _, S2, [A|S]) :- intersectv(S1, S2, S).
intersectv_3(>, A, S1, _B, S2,     S) :- intersectv_2(S2, A, S1, S).
...
subsetv_2(=, _A, S1, S2) :- subsetv(S1, S2).
