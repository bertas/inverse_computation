...
read_procedures([[a/2,a(_X109,_X110),a(_X148,_X148)|_X184],
		 [c/3,(c(_X191,_X192,_X193):-a(_X191,_X192))|_X238]|_X239],
		 _X68,[c(_X76,_X77,_X78)|_X102]) :- !.
...
bind_all(_, VarModesList) :-
	var(VarModesList).
bind_all(Mode, [[_Var, Mode]|VarModesList]) :-
	var(Mode),
