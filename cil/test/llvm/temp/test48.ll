...
@a = global [ 10 x [ 20 x %struct.fun ] ] zeroinitializer
@b = global [ 20 x %struct.fun ] * getelementptr([ 10 x [ 20 x %struct.fun ] ] * @a, i32 0, i32 0)
define i32 @f() {
entry:
        br label %S15
L19:
...
L18:
        %.t19 = mul i32 %i.7, 2
        %.t21 = load [ 20 x %struct.fun ] * * @b
        %.t22 = getelementptr [ 20 x %struct.fun ] * %.t21, i32 1
        %.t20 = getelementptr [ 20 x %struct.fun ] * %.t22, i32 0, i32 %i.7, i32 0
...
L12:
        br label %S1
L11:
        %.t12 = getelementptr [ 10 x [ 20 x %struct.fun ] ] * @a, i32 0, i32 1, i32 %i.16, i32 0
        %.t13 = load i32 * %.t12
...
L5:
        ...
        ret i32 %.t1
L4:
        %.t4 = load [ 20 x %struct.fun ] * * @b
        %.t5 = getelementptr [ 20 x %struct.fun ] * %.t4, i32 1
        %.t3 = getelementptr [ 20 x %struct.fun ] * %.t5, i32 0, i32 %i.25, i32 0
        %.t6 = load i32 * %.t3
